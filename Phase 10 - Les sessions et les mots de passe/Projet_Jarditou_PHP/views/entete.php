    ...
    <div class="container">
        ...
        <nav id="navbar" class="navbar navbar-expand-md bg-dark navbar-dark">
            ...
            <?php
                ...
                ?>
                <div><a href="http://localhost/Dw_AFPA-Eval_Php/PHP_Base_et_Avance/Phase%2010%20-%20Les%20sessions%20et%20les%20mots%20de%20passe/Formulaire.php" title="connexion">Connexion</a></div>
                <?php
            }
            ?>
        </nav>

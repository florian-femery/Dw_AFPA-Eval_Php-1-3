...
<html lang="fr">
    ...
    <body>
     ...
     <div class="col-lg-3 bg-warning mb-3">
        <a href="http://localhost/Dw_AFPA-Eval_Php/PHP_Base_et_Avance/">-:Retour</a>
     </div>   
...
<?php }?>
        ...
        <footer>
            <a href="http://localhost/Dw_AFPA-Eval_Php\PHP_Base_et_Avance\Phase 10 - Les sessions et les mots de passe\Projet_Jarditou_PHP\views\create_user_form.php">-:Inscription</a>
        </footer>
